...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/unwrap/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/%{name}/unwrap.scd.xml
%{_prefix}/dom/components/%{name}/unwrap.prf.xml
%{_prefix}/dom/components/%{name}/unwrap.spd.xml
