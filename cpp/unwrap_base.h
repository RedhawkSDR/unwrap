 ...
 */
#ifndef UNWRAP_IMPL_BASE_H
#define UNWRAP_IMPL_BASE_H
...
class unwrap_base : public Resource_impl, protected ThreadedComponent
{
    public:
        unwrap_base(const char *uuid, const char *label);
        ~unwrap_base();
